...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3474856849ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gadgetbid&table=cart_items">`gadgetbid`.`cart_items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gadgetbid&table=product">`gadgetbid`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gadgetbid&table=category">`gadgetbid`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gadgetbid&table=user">`gadgetbid`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gadgetbid&table=admin">`gadgetbid`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokolaku&table=cart_items">`tokolaku`.`cart_items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokolaku&table=users">`tokolaku`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokolaku&table=category">`tokolaku`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokolaku&table=members">`tokolaku`.`members`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokolaku&table=product">`tokolaku`.`product`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="254b2d37752f5d23252d743e2e75592a">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="gadgetbid" targettable="user">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="gadgetbid" targettable="cart_items">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `cart_items`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gadgetbid" targettable="user">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="gadgetbid" targettable="product">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="gadgetbid" targettable="category">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">ALTER TABLE `cart_items` ADD INDEX(`id_cart`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gadgetbid" targettable="category">
                            <div class="action_content">
